...
-------------------------------------------------------------------------------------------------------------------------------------------------------- */
            ...
            async submitAnalysisData() {
                ...
                try {
                    ...
                    const response = await axios.post('/api/ml/predict', dataPayload);
...
-------------------------------------------------------------------------------------------------------------------------------------------------------- */
            ...
            async submitAnalysisData1() {
                ...
                try {
                    ...
                    const response1 = await axios.post('/api/ml/predict', dataPayload1);
            ...
            async submitAnalysisData2() {
                ...
                try {
                    ...
                    const response2 = await axios.post('/api/ml/predict', dataPayload2);
